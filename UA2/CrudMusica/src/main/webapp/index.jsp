<%-- 
    Document   : index
    Created on : 3 jun 2020, 17:42:37
    Author     : izelo
--%>
...
<%
    ...
    try {
        ...
        rs = stmt.executeQuery("SELECT musica.cancion, musica.duracion, musica.grupo, musica.album, musica.año, catalogo_genero.genero FROM musica, catalogo_genero WHERE musica.id_genero=catalogo_genero.id_genero");
    } catch (Exception e) {
        out.println("Error: " + e);
    }
%>
<table class="table table-striped">
    ...
    <tr>
        ...
        <td class="text-center"><%out.println(rs.getString("año"));%></td>
